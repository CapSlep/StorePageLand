...
function sizeSelectiorInit() {
  ...
  detailBlocks.forEach(block => {
    const detailButton = block.querySelector('.detail-button');
    const detailCollapsable = block.querySelector('.detail-collapsable');
    const buttonIcon = detailButton.querySelector('.icon');
    detailButton.addEventListener('click', (event) => {
      console.log(detailCollapsable);
      detailCollapsable.classList.toggle('collapse');
      if (buttonIcon.classList.contains('icon-plus')) {
  ...
  const modalSizeTableButton = document.querySelector('.size-modal');
  modalSizeTableButton.addEventListener('click', (event) => {
    modalSizeTable();
  });

  const modalSizeTable = () => {
    ...
    modalHeading.classList.add("modal__heading-size");
    modalHeading.innerText = "ADIDAS FÚTBOL PARTES SUPERIORES PARA HOMBRE";
    ...
    const createModalText = () => {
      ...
      modalTextContent.classList.add("modal__text-size");
      modalTextContent.innerHTML = "ADIDAS FÚTBOL PARTES SUPERIORES PARA HOMBRE";
    ...
    const createModalButton = () => {
      ...
      modalButtonOk.classList.add("modal-close-button");
